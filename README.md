...
- **MVP (Model-View-Presenter)**: Another architectural pattern used for separating presentation logic from business logic.

## How to Run

1. Clone this repository:
   ```bash
   git clone https://github.com/<your-username>/wpf-calendar-app.git
