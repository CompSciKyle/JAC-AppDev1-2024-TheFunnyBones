...
namespace Calendar
{
    ...
    /// <summary>
    /// Represents a collection of events that can be managed, It provides functionality to retrieve events from reading from a file,
    ...
    public class Events
    {
        ...
        // ====================================================================
        /// <summary>
        /// Gets the name of the file associated with the events.
        /// </summary>
        /// <value>
        ...
        // ====================================================================
        /// <summary>
        /// Resets all current events and reads the new ones from the the file path provided.
        /// </summary>
        /// <param name="filepath">The file path of what you want to read from.</param>
        /// <example>
        /// Reading events from a file.
        /// <code>
        /// Events events = new Events();
        /// events.ReadFromFile("C:\Users\JohnDoe\Documents\MyNewEvents.txt");
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Writes to the file all the existing events with the file path that was specified and saves the file name info for later.
        /// </summary>
        ...
        /// <code>
        /// Events events = new Events();
        /// events.SaveToFile("C:\Users\JohnDoe\Documents\MyNewEvents.txt");
        /// </code>
        /// </example>
        ...
        /// <param name="duration">How long the event will last.</param>
        /// <param name="details">The details about the event.</param>
        /// <example>
        /// Adding a event to the events list.
        /// <code>
        /// Events events = new Events();
        /// events.Add(DateTime.Now, 1, 60, "Meeting with client");
        /// </code>
        /// </example>
        ...
        // ====================================================================
        /// <summary>
        /// Allows you to delete a event with the specified ID from the list of events.
        /// </summary>
        /// <param name="Id"> The ID of the event.</param>
        /// <example>
        /// Delete a event based of their event ID.
        /// <code>
        /// Events events = new Events();
        /// events.Delete(5);
        /// </code>
        ...
        public void Delete(int Id)
        {
            try
            {
                ...
                if (i == -1)
                {
                    throw new Exception("Error, cannot find the event ID you are trying to delete");
                }
                _Events.RemoveAt(i);
            }catch (Exception ex) 
            {
        ...
        // ====================================================================
        /// <summary>
        /// Creates a copy of the list events and duplicates it into a new list.
        /// </summary>
        /// <returns>A duplicated list of events.</returns>
        /// <example>
        /// The following example demonstrates how to delete a event with the specified ID.
        /// <code>
        /// <![CDATA[
        /// Events events = new Events();
        /// events.Add(DateTime.Now, 1, 60, "Meeting with client");
        /// List<Event>newList = events.List();
        /// ]]>
        /// </code>
        /// </example>
